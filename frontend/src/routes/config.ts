...
export const NAV_SECTIONS: RouteSection[] = [
  {
    ...
    items: [
      ...
      { label: "Tokens", to: "/wallet/tokens", icon: Coins, description: "All ERC-20 balances with USD values." },
      { label: "DeFi Positions", to: "/wallet/positions", icon: Layers, description: "Lending, LPing, staking exposures." },
      { label: "NFTs", to: "/wallet/nfts", icon: ImageIcon, description: "Collections owned with floor estimates." },
      ...
      { label: "Approvals", to: "/wallet/approvals", icon: AlertTriangle, description: "Outstanding token approvals." },
  ...
  },
  {
    ...
    items: [
      { label: "Overview", to: "/markets/overview", icon: BarChart3, description: "Total cap, BTC/ETH dominance, fear & greed." },
  ...
  },
  {
    ...
    items: [
      { label: "All Tokens", to: "/tokens", icon: Coins, description: "Sortable, filterable token universe." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Lending", to: "/defi/lending", icon: Banknote, description: "Lending-only protocols and rates." },
  ...
  },
  {
    ...
    items: [
      { label: "All Chains", to: "/chains", icon: Network, description: "Every L1/L2 ranked by TVL." },
      { label: "Compare", to: "/chains/compare", icon: ArrowRightLeft, description: "Compare TVL & history." },
      { label: "Bridges", to: "/chains/bridges", icon: Globe2, description: "Quote routes via LI.FI." },
    ],
  },
  {
    id: "onchain",
    ...
    items: [
      { label: "Wallet Lookup", to: "/onchain/wallet-lookup", icon: Search, description: "Inspect any 0x address." },
      { label: "Whale Watch", to: "/onchain/whale-watch", icon: Crown, description: "Largest recent transfers." },
      { label: "Contract", to: "/onchain/contract", icon: FileSearch, description: "ABI & verified source code." },
      { label: "Approval Checker", to: "/onchain/approval-checker", icon: AlertTriangle, description: "Risky token approvals." },
    ],
  },
  {
    id: "nft",
    ...
    items: [
      ...
      { label: "Floor Radar", to: "/nft/floor-radar", icon: BarChart3, description: "Track floor for your watchlist." },
  ...
  },
  {
    ...
    items: [
      { label: "Latest News", to: "/news", icon: Newspaper, description: "All recent headlines." },
      { label: "Categories", to: "/news/categories", icon: Layers, description: "Filter news by topic." },
  ...
  },
  {
    ...
    items: [
      { label: "General", to: "/settings/general", icon: Settings, description: "Theme, currency, locale." },
      { label: "Wallet", to: "/settings/wallet", icon: Wallet, description: "Connect / disconnect wallets." },
